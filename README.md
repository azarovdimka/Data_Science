...
- **[Оценка за экзамен]**: Веб-приложение для автоматического выставления оценки за экзамен на знание русского языка инностранными гражданами. В приложение встроен алгоритм обучения модели, если файл будет загружен с целевым признаком, а также присутсвует обученная модель, в случае загрузки датафрейма без целевого признака и выдает датафрейм с предсказанными значениями.
  Веб-приложение представлено на сайте vds.spb.su:8000 или 80.78.254.33:8000
