...
- **[Heart Attack Risk Prediction]**: API для предсказания риска сердечного приступа на основе медицинских показателей пациентов с использованием машинного обучения (CatBoost). Метрика Recall: 0.76. Приложение доступно онлайн: http://vds.spb.su:8001
