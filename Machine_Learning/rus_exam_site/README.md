...
**Тетрадка JupyterNotebook** с расчетами лежит в корне: \rus_exam_site\rus_exam.ipynb
**Сама модель** в корне: \rus_exam_site\evaluate_exam_model.pkl
**Презентация проекта** располагается в: \rus_exam_site\docs\Азаров Защита проекта.pptx
