...
> **ML-система для автоматической детекции неполных описаний отелей и минимизации потока в краудсорсинг**

## 📋 Описание проекта

Сервис **Т-Путешествия** ежедневно обрабатывает тысячи предложений по бронированию отелей от различных операторов (Booking.com, TravelLine, Expedia и др.). Для предоставления клиентам лучших цен необходимо сопоставлять эти предложения с единой сущностью — **мастер-комнатой**.
